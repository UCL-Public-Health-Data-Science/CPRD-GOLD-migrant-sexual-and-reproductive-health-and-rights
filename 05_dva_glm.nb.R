...
## Cleaning and analysing dva data for Neha's SRHR overview chapter in females of reproductive age (15-49yo) 
...
dva_count_overall_whole_cohort <- srh_annual_counts_final %>% tally(dva_n) %>% rename(n_events = n)
dva_summary_overall_whole_cohort <- srh_annual_counts_final %>% 
  summarise(mean = mean(dva_n), sd = sd(dva_n), median = median(dva_n), iqr = IQR(dva_n), 
            min = min(dva_n), max = max(dva_n))
dva_count_summary_overall_whole_cohort <- merge(dva_count_overall_whole_cohort, dva_summary_overall_whole_cohort)
dva_count_summary_overall_whole_cohort

## Overall by migrant status
dva_count_overall_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status) %>%
  tally(dva_n) %>% rename(n_events = n)
dva_summary_overall_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status) %>%
  summarise(mean = mean(dva_n), sd = sd(dva_n), median = median(dva_n), iqr = IQR(dva_n), 
            min = min(dva_n), max = max(dva_n))
dva_count_summary_overall_migrant_status <- left_join(dva_count_overall_migrant_status, dva_summary_overall_migrant_status,
                                                           by = c("migrant_status"="migrant_status" ))

## Overall by migcertainty
dva_count_overall_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty) %>%
  tally(dva_n) %>% rename(n_events = n)
dva_summary_overall_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty) %>%
  summarise(mean = mean(dva_n), sd = sd(dva_n), median = median(dva_n), iqr = IQR(dva_n), 
            min = min(dva_n), max = max(dva_n))
dva_count_summary_overall_migcertainty <- left_join(dva_count_overall_migcertainty, dva_summary_overall_migcertainty,
                                                         by = c("migcertainty"="migcertainty" ))

## Join for overall whole cohort + by migrant status
dva_count_summary_overall_final <- full_join(dva_count_summary_overall_whole_cohort, dva_count_summary_overall_migrant_status, 
                                                  by = c("n_events"="n_events", "mean" = "mean",
                                                         "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max")) %>% 
  full_join(dva_count_summary_overall_migcertainty, by = c("n_events"="n_events", "mean" = "mean",
                                                                "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max",
                                                                "migrant_status" = "migcertainty")) 
dva_count_summary_overall_final$migrant_status <- fct_explicit_na(dva_count_summary_overall_final$migrant_status, na_level = "whole_cohort")
dva_count_summary_overall_final <- dva_count_summary_overall_final %>% relocate(migrant_status)
dva_count_summary_overall_final

write_csv(dva_count_summary_overall_final, "filepath")

## Annual - whole cohort 
dva_count_annual_whole_cohort <- srh_annual_counts_final %>% group_by(eventyear) %>%
  tally(dva_n) %>% rename(n_events = n)
dva_summary_annual_whole_cohort <- srh_annual_counts_final %>% group_by(eventyear) %>%
  summarise(mean = mean(dva_n), sd = sd(dva_n), median = median(dva_n), iqr = IQR(dva_n), 
            min = min(dva_n), max = max(dva_n))
dva_count_summary_annual_whole_cohort <- left_join(dva_count_annual_whole_cohort, dva_summary_annual_whole_cohort,
                                                        by = c("eventyear"="eventyear"))


## Annual - by migrant status
dva_count_annual_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status, eventyear) %>%
  tally(dva_n) %>% rename(n_events = n)
dva_summary_annual_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status, eventyear) %>%
  summarise(mean = mean(dva_n), sd = sd(dva_n), median = median(dva_n), iqr = IQR(dva_n), 
            min = min(dva_n), max = max(dva_n))
dva_count_summary_annual_migrant_status <- left_join(dva_count_annual_migrant_status, dva_summary_annual_migrant_status,
                                                          by = c("migrant_status"="migrant_status" , "eventyear"="eventyear"))

## Annual - by migcertainty 
dva_count_annual_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty, eventyear) %>%
  tally(dva_n) %>% rename(n_events = n)
dva_summary_annual_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty, eventyear) %>%
  summarise(mean = mean(dva_n), sd = sd(dva_n), median = median(dva_n), iqr = IQR(dva_n), 
            min = min(dva_n), max = max(dva_n))
dva_count_summary_annual_migcertainty <- left_join(dva_count_annual_migcertainty, dva_summary_annual_migcertainty,
                                                        by = c("migcertainty"="migcertainty" , "eventyear"="eventyear"))

## Join to give annual for whole cohort + migrant status
dva_count_summary_annual_final <- full_join(dva_count_summary_annual_whole_cohort, dva_count_summary_annual_migrant_status, 
                                                 by = c("eventyear" = "eventyear", "n_events"="n_events", "mean" = "mean",
                                                        "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max")) 
dva_count_summary_annual_final <-   full_join(dva_count_summary_annual_final, dva_count_summary_annual_migcertainty,
                                                   by = c("eventyear" = "eventyear", "n_events"="n_events", "mean" = "mean",
                                                          "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max",
                                                          "migrant_status" = "migcertainty"))

dva_count_summary_annual_final$migrant_status <- fct_explicit_na(dva_count_summary_annual_final$migrant_status, na_level = "whole_cohort") 
dva_count_summary_annual_final <- dva_count_summary_annual_final %>% 
  relocate(migrant_status)


## Export dva summary measures
write_csv(dva_count_summary_annual_final, "filepath")

## distribution of dva counts
library(ggforce)
dva_distribution <- ggplot(srh_annual_counts_final) + geom_histogram(aes(x = dva_n), binwidth = 1) +
  facet_zoom(xlim = c(1, 10), ylim = c(0,6000)) +
  ggtitle("Distribution of dva counts") +
  labs(y="Frequency", x = "dva counts")
print(dva_distribution)
...
dvacount_mvnm <- aggregate(dva_n ~ migrant_status, srh_annual_counts_final_extra, sum) 
IR_mvnm <- inner_join(dvacount_mvnm,pyears_mvnm_overall, by= c("migrant_status" = "migrant_status"))
IR_mvnm_output <- pois.exact(IR_mvnm$dva_n, IR_mvnm$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
...
dvacount_agecat <- aggregate(dva_n ~ eventyear_agecat, srh_annual_counts_final_extra, sum) 
IR_agecat <- inner_join(dvacount_agecat,pyears_agecat_overall, by= c("eventyear_agecat" = "eventyear_agecat"))
IR_agecat_output <- pois.exact(IR_agecat$dva_n, IR_agecat$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(eventyear_agecat) + offset(log(pyears_agecat)), data = d)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dvacount_prac_region <- aggregate(dva_n ~ prac_region, srh_annual_counts_final_extra, sum) 
IR_prac_region <- inner_join(dvacount_prac_region,pyears_prac_region_overall, by= c("prac_region" = "prac_region"))
IR_prac_region_output <- pois.exact(IR_prac_region$dva_n, IR_prac_region$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(prac_region) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dvacount_imd <- aggregate(dva_n ~ imd, srh_annual_counts_final_extra, sum) 
IR_imd <- inner_join(dvacount_imd,pyears_imd_overall, by= c("imd" = "imd"))
IR_imd_output <- pois.exact(IR_imd$dva_n, IR_imd$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(imd) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dva_count_annual <- aggregate(dva_n ~ eventyear, srh_annual_counts_final_extra, sum) 
IR_annual <- inner_join(dva_count_annual,pyears_annual, by= c("eventyear" = "eventyear"))
IR_annual_output <- pois.exact(IR_annual$dva_n, IR_annual$pyears_ey, conf.level=0.95)
...
## Generate IRR via negative binomial regression univariabe for  year 
x <- glm.nb(dva_n ~ as.factor(eventyear) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
x <- glm.nb(dva_n ~ as.factor(migrant_status) + as.factor(eventyear) + as.factor(eventyear_agecat) + as.factor(imd) + as.factor(prac_region) + offset(log(pyears_ey)) , 
...
glm_all_mvnm$names <- factor(glm_all_mvnm$names, c("(Intercept)" ,"as.factor(migrant_status)Migrant", 
                                                   ...
                                                   "as.factor(imd)IMD 4",
                                                   "as.factor(imd)IMD 5",
                                                   "as.factor(prac_region)NorthEast",
                                                   "as.factor(prac_region)North West",
                                                   "as.factor(prac_region)Yorkshire & The Humber",
                                                   "as.factor(prac_region)East Midlands",
                                                   "as.factor(prac_region)West Midlands",
...
dva_glm_adj_unadj <- glm_adj_unadj
save(dva_glm_adj_unadj, file = "filepath")
...
dvacount_dp <- aggregate(dva_n ~ migcertainty, srh_annual_counts_final_extra, sum) 
IR_dp <- inner_join(dvacount_dp,pyears_dp_overall, by= c("migcertainty" = "migcertainty"))
IR_dp_output <- pois.exact(IR_dp$dva_n, IR_dp$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(migcertainty) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
## Generate IRR via negative binomial regression
srh_annual_counts_final_extra$migcertainty <- relevel(srh_annual_counts_final_extra$migcertainty, "Non-migrant")
x <- glm.nb(dva_n ~ as.factor(migcertainty) + as.factor(eventyear) + as.factor(eventyear_agecat) +  as.factor(imd) + as.factor(prac_region) + offset(log(pyears_ey)), 
            data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
...
dva_glm_dp_adj_unadj <- glm_dp_adj_unadj
save(dva_glm_dp_adj_unadj, file = "filepath")
...
dvacount_mvnm_white_british<- aggregate(dva_n ~ migrant_status, white_british, sum) 
IR_mvnm_white_british <- inner_join(dvacount_mvnm_white_british,pyears_mvnm_white_british, by= c("migrant_status" = "migrant_status"))
IR_mvnm_white_british_output <- pois.exact(IR_mvnm_white_british$dva_n, IR_mvnm_white_british$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = white_british)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dvacount_mvnm_white_nonbritish<- aggregate(dva_n ~ migrant_status, white_nonbritish, sum) 
IR_mvnm_white_nonbritish <- inner_join(dvacount_mvnm_white_nonbritish,pyears_mvnm_white_nonbritish, by= c("migrant_status" = "migrant_status"))
IR_mvnm_white_nonbritish_output <- pois.exact(IR_mvnm_white_nonbritish$dva_n, IR_mvnm_white_nonbritish$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = white_nonbritish)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dvacount_mvnm_mixed<- aggregate(dva_n ~ migrant_status, mixed, sum) 
IR_mvnm_mixed <- inner_join(dvacount_mvnm_mixed,pyears_mvnm_mixed, by= c("migrant_status" = "migrant_status"))
IR_mvnm_mixed_output <- pois.exact(IR_mvnm_mixed$dva_n, IR_mvnm_mixed$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = mixed)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dvacount_mvnm_asian<- aggregate(dva_n ~ migrant_status, asian, sum) 
IR_mvnm_asian <- inner_join(dvacount_mvnm_asian,pyears_mvnm_asian, by= c("migrant_status" = "migrant_status"))
IR_mvnm_asian_output <- pois.exact(IR_mvnm_asian$dva_n, IR_mvnm_asian$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = asian)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dvacount_mvnm_black<- aggregate(dva_n ~ migrant_status, black, sum) 
IR_mvnm_black <- inner_join(dvacount_mvnm_black,pyears_mvnm_black, by= c("migrant_status" = "migrant_status"))
IR_mvnm_black_output <- pois.exact(IR_mvnm_black$dva_n, IR_mvnm_black$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = black)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dvacount_mvnm_other<- aggregate(dva_n ~ migrant_status, other, sum) 
IR_mvnm_other <- inner_join(dvacount_mvnm_other,pyears_mvnm_other, by= c("migrant_status" = "migrant_status"))
IR_mvnm_other_output <- pois.exact(IR_mvnm_other$dva_n, IR_mvnm_other$pyears_ey, conf.level=0.95)
...
x <- glm.nb(dva_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = other)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dva_glm_adj_unadj_ethnicity <- glm_adj_unadj
save(dva_glm_adj_unadj_ethnicity, file = "filepath")
...
dvacount_mvnm <- aggregate(dva_n ~ migrant_status, exact_match_srh_annual_counts_final_extra_4to1, sum) 
IR_mvnm <- inner_join(dvacount_mvnm,pyears_mvnm_overall, by= c("migrant_status" = "migrant_status"))
IR_mvnm_output <- pois.exact(IR_mvnm$dva_n, IR_mvnm$pyears_ey, conf.level=0.95)
IR_mvnm_output <- IR_mvnm_output %>%
  mutate(incidence_rate100=rate*100)
...
x <- glm.nb(dva_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = exact_match_srh_annual_counts_final_extra_4to1)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dva_glm_adj_unadj_em <- glm_adj_unadj
save(dva_glm_adj_unadj_em, file = "filepath")
...
unadj_irr_migrant_status <- forestplot(tabletext, mean = glm_adj_unadj$estimate, lower=glm_adj_unadj$lower, upper=glm_adj_unadj$upper,
                                       ...
                                       ci.vertices = TRUE,
                                       boxsize = 0.05,
                                       title = "dva (Exact Matched Cohort)",
                                       graphwidth = unit(80, 'mm'))
dev.off()
...
pyears_dp_overall <- pyears_dp_overall %>% mutate(across(is.numeric, ~ round(.,)))
dvacount_dp <- aggregate(dva_n ~ migcertainty, exact_match_srh_annual_counts_final_extra_4to1, sum) 
IR_dp <- inner_join(dvacount_dp,pyears_dp_overall, by= c("migcertainty" = "migcertainty"))
IR_dp_output <- pois.exact(IR_dp$dva_n, IR_dp$pyears_ey, conf.level=0.95)
IR_dp_output <- IR_dp_output %>%
  mutate(incidence_rate100=rate*100)
...
x <- glm.nb(dva_n ~ as.factor(migcertainty) + offset(log(pyears_ey)), data = exact_match_srh_annual_counts_final_extra_4to1)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
dva_glm_dp_adj_unadj_em <- glm_dp_adj_unadj
save(dva_glm_dp_adj_unadj_em, file = "filepath")
...
dva_glm_adj_unadj_ethnicity_em <- glm_adj_unadj
save(dva_glm_adj_unadj_ethnicity_em, file = "filepath")
