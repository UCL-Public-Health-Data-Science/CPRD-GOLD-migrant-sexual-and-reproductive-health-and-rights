...
## Cleaning and analysing infertility_management data for Neha's SRHR overview chapter in females of reproductive age (15-49yo) 
...
infertility_management_count_overall_whole_cohort <- srh_annual_counts_final %>% tally(infertility_management_n) %>% rename(n_events = n)
infertility_management_summary_overall_whole_cohort <- srh_annual_counts_final %>% 
  summarise(mean = mean(infertility_management_n), sd = sd(infertility_management_n), median = median(infertility_management_n), iqr = IQR(infertility_management_n), 
            min = min(infertility_management_n), max = max(infertility_management_n))
infertility_management_count_summary_overall_whole_cohort <- merge(infertility_management_count_overall_whole_cohort, infertility_management_summary_overall_whole_cohort)
infertility_management_count_summary_overall_whole_cohort

## Overall by migrant status
infertility_management_count_overall_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status) %>%
  tally(infertility_management_n) %>% rename(n_events = n)
infertility_management_summary_overall_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status) %>%
  summarise(mean = mean(infertility_management_n), sd = sd(infertility_management_n), median = median(infertility_management_n), iqr = IQR(infertility_management_n), 
            min = min(infertility_management_n), max = max(infertility_management_n))
infertility_management_count_summary_overall_migrant_status <- left_join(infertility_management_count_overall_migrant_status, infertility_management_summary_overall_migrant_status,
                                                           by = c("migrant_status"="migrant_status" ))

## Overall by migcertainty
infertility_management_count_overall_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty) %>%
  tally(infertility_management_n) %>% rename(n_events = n)
infertility_management_summary_overall_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty) %>%
  summarise(mean = mean(infertility_management_n), sd = sd(infertility_management_n), median = median(infertility_management_n), iqr = IQR(infertility_management_n), 
            min = min(infertility_management_n), max = max(infertility_management_n))
infertility_management_count_summary_overall_migcertainty <- left_join(infertility_management_count_overall_migcertainty, infertility_management_summary_overall_migcertainty,
...
infertility_management_count_summary_overall_final <- full_join(infertility_management_count_summary_overall_whole_cohort, infertility_management_count_summary_overall_migrant_status, 
                                                  by = c("n_events"="n_events", "mean" = "mean",
                                                         "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max")) %>% 
  full_join(infertility_management_count_summary_overall_migcertainty, by = c("n_events"="n_events", "mean" = "mean",
                                                                "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max",
                                                                "migrant_status" = "migcertainty")) 
infertility_management_count_summary_overall_final$migrant_status <- fct_explicit_na(infertility_management_count_summary_overall_final$migrant_status, na_level = "whole_cohort")
infertility_management_count_summary_overall_final <- infertility_management_count_summary_overall_final %>% relocate(migrant_status)
infertility_management_count_summary_overall_final

write_csv(infertility_management_count_summary_overall_final, "filepath")

## Annual - whole cohort 
infertility_management_count_annual_whole_cohort <- srh_annual_counts_final %>% group_by(eventyear) %>%
  tally(infertility_management_n) %>% rename(n_events = n)
infertility_management_summary_annual_whole_cohort <- srh_annual_counts_final %>% group_by(eventyear) %>%
  summarise(mean = mean(infertility_management_n), sd = sd(infertility_management_n), median = median(infertility_management_n), iqr = IQR(infertility_management_n), 
            min = min(infertility_management_n), max = max(infertility_management_n))
infertility_management_count_summary_annual_whole_cohort <- left_join(infertility_management_count_annual_whole_cohort, infertility_management_summary_annual_whole_cohort,
                                                        by = c("eventyear"="eventyear"))


## Annual - by migrant status
infertility_management_count_annual_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status, eventyear) %>%
  tally(infertility_management_n) %>% rename(n_events = n)
infertility_management_summary_annual_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status, eventyear) %>%
  summarise(mean = mean(infertility_management_n), sd = sd(infertility_management_n), median = median(infertility_management_n), iqr = IQR(infertility_management_n), 
            min = min(infertility_management_n), max = max(infertility_management_n))
infertility_management_count_summary_annual_migrant_status <- left_join(infertility_management_count_annual_migrant_status, infertility_management_summary_annual_migrant_status,
                                                          by = c("migrant_status"="migrant_status" , "eventyear"="eventyear"))

## Annual - by migcertainty 
infertility_management_count_annual_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty, eventyear) %>%
  tally(infertility_management_n) %>% rename(n_events = n)
infertility_management_summary_annual_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty, eventyear) %>%
  summarise(mean = mean(infertility_management_n), sd = sd(infertility_management_n), median = median(infertility_management_n), iqr = IQR(infertility_management_n), 
            min = min(infertility_management_n), max = max(infertility_management_n))
infertility_management_count_summary_annual_migcertainty <- left_join(infertility_management_count_annual_migcertainty, infertility_management_summary_annual_migcertainty,
                                                        by = c("migcertainty"="migcertainty" , "eventyear"="eventyear"))



## Join to give annual for whole cohort + migrant status
infertility_management_count_summary_annual_final <- full_join(infertility_management_count_summary_annual_whole_cohort, infertility_management_count_summary_annual_migrant_status, 
                                                 by = c("eventyear" = "eventyear", "n_events"="n_events", "mean" = "mean",
                                                        "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max")) 
infertility_management_count_summary_annual_final <-   full_join(infertility_management_count_summary_annual_final, infertility_management_count_summary_annual_migcertainty,
                                                   by = c("eventyear" = "eventyear", "n_events"="n_events", "mean" = "mean",
                                                          "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max",
                                                          "migrant_status" = "migcertainty"))

infertility_management_count_summary_annual_final$migrant_status <- fct_explicit_na(infertility_management_count_summary_annual_final$migrant_status, na_level = "whole_cohort") 
infertility_management_count_summary_annual_final <- infertility_management_count_summary_annual_final %>% 
  relocate(migrant_status)


## Export infertility_management summary measures
write_csv(infertility_management_count_summary_annual_final, "filepath")

## distribution of infertility_management counts
library(ggforce)
infertility_management_distribution <- ggplot(srh_annual_counts_final) + geom_histogram(aes(x = infertility_management_n), binwidth = 1) +
  facet_zoom(xlim = c(1, 8), ylim = c(0,10000)) +
  ggtitle("Distribution of infertility_management counts") +
  labs(y="Frequency", x = "infertility_management counts")
print(infertility_management_distribution)
...
infertility_managementcount_mvnm <- aggregate(infertility_management_n ~ migrant_status, srh_annual_counts_final_extra, sum) 
IR_mvnm <- inner_join(infertility_managementcount_mvnm,pyears_mvnm_overall, by= c("migrant_status" = "migrant_status"))
IR_mvnm_output <- pois.exact(IR_mvnm$infertility_management_n, IR_mvnm$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
...
a<- srh_annual_counts_final_extra %>% group_by(patid, eventyear_agecat) %>% 
  tally(infertility_management_n)
...
d<- left_join(c, reproductive_cohort_final, by = c("patid" = "patid")) %>% 
  rename(infertility_management_n = n.x) %>% 
...
infertility_managementcount_agecat <- aggregate(infertility_management_n ~ eventyear_agecat, srh_annual_counts_final_extra, sum) 
IR_agecat <- inner_join(infertility_managementcount_agecat,pyears_agecat_overall, by= c("eventyear_agecat" = "eventyear_agecat"))
IR_agecat_output <- pois.exact(IR_agecat$infertility_management_n, IR_agecat$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(eventyear_agecat) + offset(log(pyears_agecat)), data = d)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_managementcount_prac_region <- aggregate(infertility_management_n ~ prac_region, srh_annual_counts_final_extra, sum) 
IR_prac_region <- inner_join(infertility_managementcount_prac_region,pyears_prac_region_overall, by= c("prac_region" = "prac_region"))
IR_prac_region_output <- pois.exact(IR_prac_region$infertility_management_n, IR_prac_region$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(prac_region) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_managementcount_imd <- aggregate(infertility_management_n ~ imd, srh_annual_counts_final_extra, sum) 
IR_imd <- inner_join(infertility_managementcount_imd,pyears_imd_overall, by= c("imd" = "imd"))
IR_imd_output <- pois.exact(IR_imd$infertility_management_n, IR_imd$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(imd) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_management_count_annual <- aggregate(infertility_management_n ~ eventyear, srh_annual_counts_final_extra, sum) 
IR_annual <- inner_join(infertility_management_count_annual,pyears_annual, by= c("eventyear" = "eventyear"))
IR_annual_output <- pois.exact(IR_annual$infertility_management_n, IR_annual$pyears_ey, conf.level=0.95)
...
## Generate IRR via negative binomial regression univariabe for  year 
x <- glm.nb(infertility_management_n ~ as.factor(eventyear) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
x <- glm.nb(infertility_management_n ~ as.factor(migrant_status) + as.factor(eventyear) + as.factor(eventyear_agecat) + as.factor(imd) + as.factor(prac_region) + offset(log(pyears_ey)) , 
...
infertility_management_glm_dp_adj_unadj <- glm_dp_adj_unadj
save(infertility_management_glm_dp_adj_unadj, file = "filepath")
...
infertility_managementcount_dp <- aggregate(infertility_management_n ~ migcertainty, srh_annual_counts_final_extra, sum) 
IR_dp <- inner_join(infertility_managementcount_dp,pyears_dp_overall, by= c("migcertainty" = "migcertainty"))
IR_dp_output <- pois.exact(IR_dp$infertility_management_n, IR_dp$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(migcertainty) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
## Generate IRR via negative binomial regression
srh_annual_counts_final_extra$migcertainty <- relevel(srh_annual_counts_final_extra$migcertainty, "Non-migrant")
x <- glm.nb(infertility_management_n ~ as.factor(migcertainty) + as.factor(eventyear) + as.factor(eventyear_agecat) +  as.factor(imd) + as.factor(prac_region) + offset(log(pyears_ey)), 
            data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
...
infertility_managementcount_mvnm_white_british<- aggregate(infertility_management_n ~ migrant_status, white_british, sum) 
IR_mvnm_white_british <- inner_join(infertility_managementcount_mvnm_white_british,pyears_mvnm_white_british, by= c("migrant_status" = "migrant_status"))
IR_mvnm_white_british_output <- pois.exact(IR_mvnm_white_british$infertility_management_n, IR_mvnm_white_british$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = white_british)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_managementcount_mvnm_white_nonbritish<- aggregate(infertility_management_n ~ migrant_status, white_nonbritish, sum) 
IR_mvnm_white_nonbritish <- inner_join(infertility_managementcount_mvnm_white_nonbritish,pyears_mvnm_white_nonbritish, by= c("migrant_status" = "migrant_status"))
IR_mvnm_white_nonbritish_output <- pois.exact(IR_mvnm_white_nonbritish$infertility_management_n, IR_mvnm_white_nonbritish$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = white_nonbritish)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_managementcount_mvnm_mixed<- aggregate(infertility_management_n ~ migrant_status, mixed, sum) 
IR_mvnm_mixed <- inner_join(infertility_managementcount_mvnm_mixed,pyears_mvnm_mixed, by= c("migrant_status" = "migrant_status"))
IR_mvnm_mixed_output <- pois.exact(IR_mvnm_mixed$infertility_management_n, IR_mvnm_mixed$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = mixed)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_managementcount_mvnm_asian<- aggregate(infertility_management_n ~ migrant_status, asian, sum) 
IR_mvnm_asian <- inner_join(infertility_managementcount_mvnm_asian,pyears_mvnm_asian, by= c("migrant_status" = "migrant_status"))
IR_mvnm_asian_output <- pois.exact(IR_mvnm_asian$infertility_management_n, IR_mvnm_asian$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = asian)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_managementcount_mvnm_black<- aggregate(infertility_management_n ~ migrant_status, black, sum) 
IR_mvnm_black <- inner_join(infertility_managementcount_mvnm_black,pyears_mvnm_black, by= c("migrant_status" = "migrant_status"))
IR_mvnm_black_output <- pois.exact(IR_mvnm_black$infertility_management_n, IR_mvnm_black$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = black)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_managementcount_mvnm_other<- aggregate(infertility_management_n ~ migrant_status, other, sum) 
IR_mvnm_other <- inner_join(infertility_managementcount_mvnm_other,pyears_mvnm_other, by= c("migrant_status" = "migrant_status"))
IR_mvnm_other_output <- pois.exact(IR_mvnm_other$infertility_management_n, IR_mvnm_other$pyears_ey, conf.level=0.95)
...
x <- glm.nb(infertility_management_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = other)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_management_glm_adj_unadj_ethnicity <- glm_adj_unadj
save(infertility_management_glm_adj_unadj_ethnicity, file = "filepath")
...
tabletext <- cbind(c("Non-migrants", "White British ethnicity - Migrants (unadjusted)", "White British ethnicity - Migrants (fully adjusted)",
                   ...
                   c(glm_adj_unadj$ci))
dev.new()
png(file = "results/infertility_management/irrs_migrant_status_ethnicity.png", width = 800, height = 700)
...
load(file = "cleaned_files/exact_match_reproductive_cohort_final_4to1.Rdata")
load(file = "cleaned_files/exact_match_srh_annual_counts_final_4to1.Rdata")
load(file = "cleaned_files/exact_match_srh_annual_counts_final_extra_4to1.Rdata")
...
infertility_managementcount_mvnm <- aggregate(infertility_management_n ~ migrant_status, exact_match_srh_annual_counts_final_extra_4to1, sum) 
IR_mvnm <- inner_join(infertility_managementcount_mvnm,pyears_mvnm_overall, by= c("migrant_status" = "migrant_status"))
IR_mvnm_output <- pois.exact(IR_mvnm$infertility_management_n, IR_mvnm$pyears_ey, conf.level=0.95)
IR_mvnm_output <- IR_mvnm_output %>%
  mutate(incidence_rate100=rate*100)
...
x <- glm.nb(infertility_management_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = exact_match_srh_annual_counts_final_extra_4to1)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_management_glm_adj_unadj_em <- glm_adj_unadj
save(infertility_management_glm_adj_unadj_em, file = "filepath")
...
unadj_irr_migrant_status <- forestplot(tabletext, mean = glm_adj_unadj$estimate, lower=glm_adj_unadj$lower, upper=glm_adj_unadj$upper,
                                       ...
                                       ci.vertices = TRUE,
                                       boxsize = 0.05,
                                       title = "infertility_management (Exact Matched Cohort)",
                                       graphwidth = unit(80, 'mm'))
dev.off()
...
pyears_dp_overall <- pyears_dp_overall %>% mutate(across(is.numeric, ~ round(.,)))
infertility_managementcount_dp <- aggregate(infertility_management_n ~ migcertainty, exact_match_srh_annual_counts_final_extra_4to1, sum) 
IR_dp <- inner_join(infertility_managementcount_dp,pyears_dp_overall, by= c("migcertainty" = "migcertainty"))
IR_dp_output <- pois.exact(IR_dp$infertility_management_n, IR_dp$pyears_ey, conf.level=0.95)
IR_dp_output <- IR_dp_output %>%
  mutate(incidence_rate100=rate*100)
...
x <- glm.nb(infertility_management_n ~ as.factor(migcertainty) + offset(log(pyears_ey)), data = exact_match_srh_annual_counts_final_extra_4to1)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
infertility_management_glm_dp_adj_unadj_em <- glm_dp_adj_unadj
save(infertility_management_glm_dp_adj_unadj_em, file = "filepath")
...
irrs_migcertainty <- forestplot(tabletext, mean = glm_dp_adj_unadj$estimate, lower=glm_dp_adj_unadj$lower, upper=glm_dp_adj_unadj$upper,
                                ...
                                ci.vertices = TRUE,
                                boxsize = 0.05,
                                title = "infertility_management Overall",
                                graphwidth = unit(80, 'mm'))
dev.off()
...
infertility_management_glm_adj_unadj_ethnicity_em <- glm_adj_unadj
save(infertility_management_glm_adj_unadj_ethnicity_em, file = "filepath")
