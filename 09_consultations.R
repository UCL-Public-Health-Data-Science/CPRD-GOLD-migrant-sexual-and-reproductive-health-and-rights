...
## Cleaning and analysing consultations data for Neha's SRHR overview chapter in females of reproductive age (15-49yo) 
...
consultations_count_overall_whole_cohort <- srh_annual_counts_final %>% tally(consultations_n) %>% rename(n_events = n)
a <- srh_annual_counts_final %>% group_by(patid) %>% tally(consultations_n) %>% rename(n_events = n) 
x <- srh_annual_counts_final %>% group_by(patid) %>% tally(consultations_n) %>% rename(n_events = n) %>% 
  summarise(mean = mean(n_events), sd = sd(n_events), median = median(n_events), iqr = IQR(n_events), 
            min = min(n_events), max = max(n_events)) %>% mutate(across(is.numeric, ~ round(.,2)))

consultations_summary_overall_whole_cohort <- srh_annual_counts_final %>% 
  summarise(mean = mean(consultations_n), sd = sd(consultations_n), median = median(consultations_n), iqr = IQR(consultations_n), 
            min = min(consultations_n), max = max(consultations_n))
consultations_count_summary_overall_whole_cohort <- merge(consultations_count_overall_whole_cohort, consultations_summary_overall_whole_cohort)
consultations_count_summary_overall_whole_cohort

## Overall by migrant status
consultations_count_overall_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status) %>%
  tally(consultations_n) %>% rename(n_events = n)
consultations_summary_overall_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status) %>%
  summarise(mean = mean(consultations_n), sd = sd(consultations_n), median = median(consultations_n), iqr = IQR(consultations_n), 
            min = min(consultations_n), max = max(consultations_n))
consultations_count_summary_overall_migrant_status <- left_join(consultations_count_overall_migrant_status, consultations_summary_overall_migrant_status,
                                                                 by = c("migrant_status"="migrant_status" ))

## Overall by migcertainty
consultations_count_overall_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty) %>%
  tally(consultations_n) %>% rename(n_events = n)
consultations_summary_overall_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty) %>%
  summarise(mean = mean(consultations_n), sd = sd(consultations_n), median = median(consultations_n), iqr = IQR(consultations_n), 
            min = min(consultations_n), max = max(consultations_n))
consultations_count_summary_overall_migcertainty <- left_join(consultations_count_overall_migcertainty, consultations_summary_overall_migcertainty,
...
consultations_count_summary_overall_final <- full_join(consultations_count_summary_overall_whole_cohort, consultations_count_summary_overall_migrant_status, 
                                                        by = c("n_events"="n_events", "mean" = "mean",
                                                               "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max")) %>% 
  full_join(consultations_count_summary_overall_migcertainty, by = c("n_events"="n_events", "mean" = "mean",
                                                                      "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max",
                                                                      "migrant_status" = "migcertainty")) 
consultations_count_summary_overall_final$migrant_status <- fct_explicit_na(consultations_count_summary_overall_final$migrant_status, na_level = "whole_cohort")
consultations_count_summary_overall_final <- consultations_count_summary_overall_final %>% relocate(migrant_status)
consultations_count_summary_overall_final

write_csv(consultations_count_summary_overall_final, "filepath" )

## Annual - whole cohort 
consultations_count_annual_whole_cohort <- srh_annual_counts_final %>% group_by(eventyear) %>%
  tally(consultations_n) %>% rename(n_events = n)
consultations_summary_annual_whole_cohort <- srh_annual_counts_final %>% group_by(eventyear) %>%
  summarise(mean = mean(consultations_n), sd = sd(consultations_n), median = median(consultations_n), iqr = IQR(consultations_n), 
            min = min(consultations_n), max = max(consultations_n))
consultations_count_summary_annual_whole_cohort <- left_join(consultations_count_annual_whole_cohort, consultations_summary_annual_whole_cohort,
                                                              by = c("eventyear"="eventyear"))


## Annual - by migrant status
consultations_count_annual_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status, eventyear) %>%
  tally(consultations_n) %>% rename(n_events = n)
consultations_summary_annual_migrant_status <- srh_annual_counts_final %>% group_by(migrant_status, eventyear) %>%
  summarise(mean = mean(consultations_n), sd = sd(consultations_n), median = median(consultations_n), iqr = IQR(consultations_n), 
            min = min(consultations_n), max = max(consultations_n))
consultations_count_summary_annual_migrant_status <- left_join(consultations_count_annual_migrant_status, consultations_summary_annual_migrant_status,
                                                                by = c("migrant_status"="migrant_status" , "eventyear"="eventyear"))

## Annual - by migcertainty 
consultations_count_annual_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty, eventyear) %>%
  tally(consultations_n) %>% rename(n_events = n)
consultations_summary_annual_migcertainty <- srh_annual_counts_final %>% group_by(migcertainty, eventyear) %>%
  summarise(mean = mean(consultations_n), sd = sd(consultations_n), median = median(consultations_n), iqr = IQR(consultations_n), 
            min = min(consultations_n), max = max(consultations_n))
consultations_count_summary_annual_migcertainty <- left_join(consultations_count_annual_migcertainty, consultations_summary_annual_migcertainty,
                                                              by = c("migcertainty"="migcertainty" , "eventyear"="eventyear"))



## Join to give annual for whole cohort + migrant status
consultations_count_summary_annual_final <- full_join(consultations_count_summary_annual_whole_cohort, consultations_count_summary_annual_migrant_status, 
                                                       by = c("eventyear" = "eventyear", "n_events"="n_events", "mean" = "mean",
                                                              "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max")) 
consultations_count_summary_annual_final <-   full_join(consultations_count_summary_annual_final, consultations_count_summary_annual_migcertainty,
                                                         by = c("eventyear" = "eventyear", "n_events"="n_events", "mean" = "mean",
                                                                "sd"="sd", "median"="median", "iqr"="iqr", "min"="min", "max"="max",
                                                                "migrant_status" = "migcertainty"))

consultations_count_summary_annual_final$migrant_status <- fct_explicit_na(consultations_count_summary_annual_final$migrant_status, na_level = "whole_cohort") 
consultations_count_summary_annual_final <- consultations_count_summary_annual_final %>% 
  relocate(migrant_status)


## Export consultations summary measures
write_csv(consultations_count_summary_annual_final, "filepath")

## distribution of consultation counts
library(ggforce)
cons_distribution <- ggplot(srh_annual_counts_final) + geom_histogram(aes(x = consultations_n), binwidth = 10) +
  facet_zoom(xlim = c(50, 500), ylim = c(0,100), y = disp>300) +
  ggtitle(str_wrap("Distribution of consultation counts", 60)) +
  labs(y="Frequency", x = "Consultation counts")
print(cons_distribution)
...
consultationscount_mvnm <- aggregate(consultations_n ~ migrant_status, srh_annual_counts_final_extra, sum) 
IR_mvnm <- inner_join(consultationscount_mvnm,pyears_mvnm_overall, by= c("migrant_status" = "migrant_status"))
IR_mvnm_output <- pois.exact(IR_mvnm$consultations_n, IR_mvnm$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
...
consultationscount_agecat <- aggregate(consultations_n ~ eventyear_agecat, srh_annual_counts_final_extra, sum) 
IR_agecat <- inner_join(consultationscount_agecat,pyears_agecat_overall, by= c("eventyear_agecat" = "eventyear_agecat"))
IR_agecat_output <- pois.exact(IR_agecat$consultations_n, IR_agecat$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(eventyear_agecat) + offset(log(pyears_agecat)), data = d)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
consultationscount_prac_region <- aggregate(consultations_n ~ prac_region, srh_annual_counts_final_extra, sum) 
IR_prac_region <- inner_join(consultationscount_prac_region,pyears_prac_region_overall, by= c("prac_region" = "prac_region"))
IR_prac_region_output <- pois.exact(IR_prac_region$consultations_n, IR_prac_region$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(prac_region) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
consultationscount_imd <- aggregate(consultations_n ~ imd, srh_annual_counts_final_extra, sum) 
IR_imd <- inner_join(consultationscount_imd,pyears_imd_overall, by= c("imd" = "imd"))
IR_imd_output <- pois.exact(IR_imd$consultations_n, IR_imd$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(imd) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
consultations_count_annual <- aggregate(consultations_n ~ eventyear, srh_annual_counts_final_extra, sum) 
IR_annual <- inner_join(consultations_count_annual,pyears_annual, by= c("eventyear" = "eventyear"))
IR_annual_output <- pois.exact(IR_annual$consultations_n, IR_annual$pyears_ey, conf.level=0.95)
...
## Generate IRR via negative binomial regression univariabe for  year 
x <- glm.nb(consultations_n ~ as.factor(eventyear) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
x <- glm.nb(consultations_n ~ as.factor(migrant_status) + as.factor(eventyear) + as.factor(eventyear_agecat) + as.factor(imd) + as.factor(prac_region) + offset(log(pyears_ey)) , 
...
cons_glm_adj_unadj <- glm_adj_unadj
save(cons_glm_adj_unadj, file = "filepath")
...
consultationscount_dp <- aggregate(consultations_n ~ migcertainty, srh_annual_counts_final_extra, sum) 
IR_dp <- inner_join(consultationscount_dp,pyears_dp_overall, by= c("migcertainty" = "migcertainty"))
IR_dp_output <- pois.exact(IR_dp$consultations_n, IR_dp$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(migcertainty) + offset(log(pyears_ey)), data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
## Generate IRR via negative binomial regression
srh_annual_counts_final_extra$migcertainty <- relevel(srh_annual_counts_final_extra$migcertainty, "Non-migrant")
x <- glm.nb(consultations_n ~ as.factor(migcertainty) + as.factor(eventyear) + as.factor(eventyear_agecat) +  as.factor(imd) + as.factor(prac_region) + offset(log(pyears_ey)), 
            data = srh_annual_counts_final_extra)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
...
cons_glm_dp_adj_unadj <- glm_dp_adj_unadj
save(cons_glm_dp_adj_unadj, file = "filepath")
...
consultationscount_mvnm_white_british<- aggregate(consultations_n ~ migrant_status, white_british, sum) 
IR_mvnm_white_british <- inner_join(consultationscount_mvnm_white_british,pyears_mvnm_white_british, by= c("migrant_status" = "migrant_status"))
IR_mvnm_white_british_output <- pois.exact(IR_mvnm_white_british$consultations_n, IR_mvnm_white_british$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = white_british)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
consultationscount_mvnm_white_nonbritish<- aggregate(consultations_n ~ migrant_status, white_nonbritish, sum) 
IR_mvnm_white_nonbritish <- inner_join(consultationscount_mvnm_white_nonbritish,pyears_mvnm_white_nonbritish, by= c("migrant_status" = "migrant_status"))
IR_mvnm_white_nonbritish_output <- pois.exact(IR_mvnm_white_nonbritish$consultations_n, IR_mvnm_white_nonbritish$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = white_nonbritish)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
consultationscount_mvnm_mixed<- aggregate(consultations_n ~ migrant_status, mixed, sum) 
IR_mvnm_mixed <- inner_join(consultationscount_mvnm_mixed,pyears_mvnm_mixed, by= c("migrant_status" = "migrant_status"))
IR_mvnm_mixed_output <- pois.exact(IR_mvnm_mixed$consultations_n, IR_mvnm_mixed$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = mixed)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
consultationscount_mvnm_asian<- aggregate(consultations_n ~ migrant_status, asian, sum) 
IR_mvnm_asian <- inner_join(consultationscount_mvnm_asian,pyears_mvnm_asian, by= c("migrant_status" = "migrant_status"))
IR_mvnm_asian_output <- pois.exact(IR_mvnm_asian$consultations_n, IR_mvnm_asian$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = asian)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
consultationscount_mvnm_black<- aggregate(consultations_n ~ migrant_status, black, sum) 
IR_mvnm_black <- inner_join(consultationscount_mvnm_black,pyears_mvnm_black, by= c("migrant_status" = "migrant_status"))
IR_mvnm_black_output <- pois.exact(IR_mvnm_black$consultations_n, IR_mvnm_black$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = black)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
consultationscount_mvnm_other<- aggregate(consultations_n ~ migrant_status, other, sum) 
IR_mvnm_other <- inner_join(consultationscount_mvnm_other,pyears_mvnm_other, by= c("migrant_status" = "migrant_status"))
IR_mvnm_other_output <- pois.exact(IR_mvnm_other$consultations_n, IR_mvnm_other$pyears_ey, conf.level=0.95)
...
x <- glm.nb(consultations_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = other)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
cons_glm_adj_unadj_ethnicity <- glm_adj_unadj
save(cons_glm_adj_unadj_ethnicity, file = "filepath")
...
pyears_mvnm_overall <- pyears_mvnm_overall %>% mutate(across(is.numeric, ~ round(.,0)))
consultationscount_mvnm <- aggregate(consultations_n ~ migrant_status, exact_match_srh_annual_counts_final_extra_4to1, sum) 
IR_mvnm <- inner_join(consultationscount_mvnm,pyears_mvnm_overall, by= c("migrant_status" = "migrant_status"))
IR_mvnm_output <- pois.exact(IR_mvnm$consultations_n, IR_mvnm$pyears_ey, conf.level=0.95)
IR_mvnm_output <- IR_mvnm_output %>%
  mutate(incidence_rate100=rate*100)
...
x <- glm.nb(consultations_n ~ as.factor(migrant_status) + offset(log(pyears_ey)), data = exact_match_srh_annual_counts_final_extra_4to1)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
cons_glm_adj_unadj_em <- glm_adj_unadj
save(cons_glm_adj_unadj_em, file = "filepath")
...
unadj_irr_migrant_status <- forestplot(tabletext, mean = glm_adj_unadj$estimate, lower=glm_adj_unadj$lower, upper=glm_adj_unadj$upper,
                                       ...
                                       ci.vertices = TRUE,
                                       boxsize = 0.05,
                                       title = "Consultations Overall (Exact Matched Cohort)",
                                       graphwidth = unit(80, 'mm'))
dev.off()
...
pyears_dp_overall <- pyears_dp_overall %>% mutate(across(is.numeric, ~ round(.,)))
consultationscount_dp <- aggregate(consultations_n ~ migcertainty, exact_match_srh_annual_counts_final_extra_4to1, sum) 
IR_dp <- inner_join(consultationscount_dp,pyears_dp_overall, by= c("migcertainty" = "migcertainty"))
IR_dp_output <- pois.exact(IR_dp$consultations_n, IR_dp$pyears_ey, conf.level=0.95)
IR_dp_output <- IR_dp_output %>%
  mutate(incidence_rate100=rate*100)
...
x <- glm.nb(consultations_n ~ as.factor(migcertainty) + offset(log(pyears_ey)), data = exact_match_srh_annual_counts_final_extra_4to1)
names <- names(coef(x))
estimate<- exp(coef(x))
confint.default <- exp(confint.default(x))
p <- coef(summary(x))[,4]
...
cons_glm_dp_adj_unadj_em <- glm_dp_adj_unadj
save(cons_glm_dp_adj_unadj_em, file = "filepath")
...
cons_glm_adj_unadj_ethnicity_em <- glm_adj_unadj
save(cons_glm_adj_unadj_ethnicity_em, file = "filepath")
